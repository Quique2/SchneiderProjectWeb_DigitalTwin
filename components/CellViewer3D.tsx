...
function CafiMesh({
  ...
  useFrame(() => {
    ...
    if (frame) {
      ...
      // While grasped, swap the CAFI's long axis (mesh X) onto the gripper's
      // close direction (gripper Y) — V53 lateral grasp.  Without this extra
      // rotation the CAFI extends perpendicular to the jaws and looks wrong.
      if (state === 'in_gripper') {
